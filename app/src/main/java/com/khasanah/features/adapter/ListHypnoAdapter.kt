...
class ListHypnoAdapter(val context: Context, private val list: MutableList<ResponseHypnoDto.Data>) : RecyclerView.Adapter<ListHypnoAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        list[position].nav = R.id.menuHypnoWebView
