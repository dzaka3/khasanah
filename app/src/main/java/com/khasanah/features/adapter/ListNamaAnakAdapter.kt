...
class ListNamaAnakAdapter(val context: Context, private val list: MutableList<ResponseChildDto.Data>) : RecyclerView.Adapter<ListNamaAnakAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        list[position].nav = R.id.menuEditDataAnak

        holder.itemView.setOnClickListener {
            val bundle = bundleOf(Constant.KEY_ID_TITTLE to moshi.adapter(ResponseChildDto.Data::class.java).toJson(list[position]))
