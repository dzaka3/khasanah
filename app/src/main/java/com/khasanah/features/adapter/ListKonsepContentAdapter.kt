...
class ListKonsepContentAdapter(val context: Context, private val list: MutableList<TheoryDto.Data>) : RecyclerView.Adapter<ListKonsepContentAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        list[position].nav = R.id.menuKonsepDetail

        holder.itemView.setOnClickListener {
            val bundle = bundleOf(Constant.KEY_ID_TITTLE to moshi.adapter(TheoryDto.Data::class.java).toJson(list[position]))
